...
public class CommentAPIFormTest
{
    ...
    [Fact]
    public async Task CommentAPIForm_WithInvalidData_ShouldReturnBadRequest()
    {
        // Arrange
        var patientId = Guid.NewGuid();
        var APIForm = new Domain.Models.OralHealthExamination.API();
    ...
    [Fact]
    public async Task CommentAPIForm_WithInvalidPatientExaminationCard_ShouldReturnBadRequest()
    {
        // Arrange
