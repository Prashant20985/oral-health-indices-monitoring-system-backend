...
/// <summary>
/// Represents a practice bleeding assessment.
/// </summary>
/// <param name="bleedingResult">The result of the bleeding assessment.</param>
public class PracticeBleeding(int bleedingResult, int maxilla, int mandible)
{
    /// <summary>
    ...
    /// </summary>
    public int BleedingResult { get; private set; } = bleedingResult;

    /// <summary>
    /// Gets the bleeding result of the maxilla.
    /// </summary>
    public int Maxilla { get; private set; } = maxilla;

    /// <summary>
    /// Gets the bleeding result of the mandible.
    /// </summary>
