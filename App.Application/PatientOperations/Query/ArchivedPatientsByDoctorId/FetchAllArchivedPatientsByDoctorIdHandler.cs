...
internal sealed class FetchAllArchivedPatientsByDoctorIdHandler(IPatientRepository patientRepository)
        : IRequestHandler<FetchAllArchivedPatientsByDoctorIdQuery, OperationResult<List<PatientResponseDto>>>
{
    ...
    public async Task<OperationResult<List<PatientResponseDto>>> Handle(FetchAllArchivedPatientsByDoctorIdQuery request, CancellationToken cancellationToken)
    {
