...
internal sealed class UpdateAPIFormHandler(IPatientExaminationCardRepository patientExaminationCardRepository)
    : IRequestHandler<UpdateAPIFormCommand, OperationResult<Unit>>
{
    ...
    public async Task<OperationResult<Unit>> Handle(UpdateAPIFormCommand request, CancellationToken cancellationToken)
    {
