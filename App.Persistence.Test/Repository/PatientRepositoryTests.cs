...
public class PatientRepositoryTests
{
    ...
    [Fact]
    public void GetAllActivePatientsByDoctorId_WhenPatientsExist_ShouldReturnAllActivePatientsByDoctorId()
    {
        // Arrange
        var patient1 = new Patient("test", "test", "test@test.com", Gender.Male, "test", "test", 19, "test", "test", "test", "test", 1, "test");
        var patient2 = new Patient("test1", "test1", "test1@test.com", Gender.Male, "test1", "test1", 19, "test1", "test1", "test1", "test1", 1, "test");
        ...
        //Act
        var result = _patientRepository.GetAllActivePatientsByDoctorId("test");
    ...
    [Fact]
    public void GetAllActivePatientsByDoctorId_WhenNoPatientsExist_ShouldReturnEmptyList()
    {
        // Arrange
        var patient1 = new Patient("test", "test", "test@test.com", Gender.Male, "test", "test", 19, "test", "test", "test", "test", 1, "test1");
        var patient2 = new Patient("test1", "test1", "test1@test.com", Gender.Male, "test1", "test1", 19, "test1", "test1", "test1", "test1", 1, "test1");
    ...
    [Fact]
    public void GetAllArchivedPatientsByDoctorId_WhenPatientsExist_ShouldReturnAllArchivedPatientsByDoctorId()
    {
        // Arrange
        var patient1 = new Patient("test", "test", "test@test.com", Gender.Male, "test", "test", 19, "test", "test", "test", "test", 1, "test");
        var patient2 = new Patient("test1", "test1", "test1@test.com", Gender.Male, "test1", "test1", 19, "test1", "test1", "test1", "test1", 1, "test");
        ...
        //Act
        var result = _patientRepository.GetAllArchivedPatientsByDoctorId("test");
    ...
    [Fact]
    public void GetAllArchivedPatientsByDoctorId_WhenNoPatientsExist_ShouldReturnEmptyList()
    {
        // Arrange
        var patient1 = new Patient("test", "test", "test@test.com", Gender.Male, "test", "test", 19, "test", "test", "test", "test", 1, "test");
        var patient2 = new Patient("test1", "test1", "test1@test.com", Gender.Male, "test1", "test1", 19, "test1", "test1", "test1", "test1", 1, "test");
