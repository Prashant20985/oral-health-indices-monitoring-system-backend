...
public class TestHelper
{
    ...
    /// <summary>
    ///     Mock instance for the IPatientExaminationCardRepository interface, used to simulate
    ///     patientExaminationCardRepository service behavior in tests.
    /// </summary>
    ...
    /// </summary>
    protected Mock<IApplicationUsersListQueryFilter> queryFilterMock;

    /// <summary>
    ///     Mock instance for the IResearchGroupRepository interface, used to simulate researchGroupRepository service behavior
    ///     in tests.
    /// </summary>
    protected Mock<IResearchGroupRepository> researchGroupRepositoryMock;

    /// <summary>
    ///     Mock instance for the IStudentExamRepository interface, used to simulate studentExamRepository service behavior in
    ///     tests.
    /// </summary>
    protected Mock<IStudentExamRepository> studentExamRepositoryMock;

    /// <summary>
    ///     Mock instance for the ISuperviseRepository interface, used to simulate superviseRepository service behavior in
    ///     tests.
    /// </summary>
    ...
    /// <summary>
    ///     Mock instance for the IUserContextUnitOfWork interface, used to simulate UserContextUnitOfWork service behavior in
    ///     tests.
    /// </summary>
    ...
    /// <summary>
    ///     Mock instance for the IUserRequestRepository interface, used to simulate userRequestRepository service behavior in
    ///     tests.
    /// </summary>
    ...
    public TestHelper()
    {
        ...
        queryFilterMock = new Mock<IApplicationUsersListQueryFilter>();
