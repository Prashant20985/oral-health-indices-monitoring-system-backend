...
{
    private readonly List<CreateApplicationUserDto> createApplicationUserDtos;
    ...
    {
        createApplicationUserDtos = new List<CreateApplicationUserDto>()
        {
        ...
        handler = new CreateApplicationUsersFromCsvHandler(mediatorMock.Object, readCsvMock.Object);
    }
    ...
    public async Task CreateApplicationUsersFromCsv_Success_ReturnsSuccessResult()
    {
        ...
        readCsvMock.Setup(csv => csv.ReadApplicationUsersFromCsv(fileMock.Object))
                .Returns(createApplicationUserDtos);
    ...
    public async Task CreateApplicationUsersFromCsv_NoUsersInCsv_ReturnsFailureResult()
    {
        ...
        readCsvMock.Setup(csv => csv.ReadApplicationUsersFromCsv(fileMock.Object))
            .Returns(new List<CreateApplicationUserDto>());
