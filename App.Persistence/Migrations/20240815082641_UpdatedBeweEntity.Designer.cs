...
namespace App.Persistence.Migrations
{
    ...
    [Migration("20240815082641_UpdatedBeweEntity")]
    partial class UpdatedBeweEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Domain.Models.CreditSchema.PracticeBewe", b =>
                {
                    ...
                    b.Property<decimal>("Sectant1")
                        .HasColumnType("numeric");

                    b.Property<decimal>("Sectant2")
                        .HasColumnType("numeric");

                    b.Property<decimal>("Sectant3")
                        .HasColumnType("numeric");

                    b.Property<decimal>("Sectant4")
                        .HasColumnType("numeric");

                    b.Property<decimal>("Sectant5")
                        .HasColumnType("numeric");

                    b.Property<decimal>("Sectant6")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("App.Domain.Models.CreditSchema.PracticeDMFT_DMFS", b =>
                {
                    ...
                    b.Property<string>("ProstheticStatus")
                        .HasMaxLength(1)
            ...
            modelBuilder.Entity("App.Domain.Models.CreditSchema.PracticePatientExaminationCard", b =>
                {
                    ...
                    b.Property<string>("NeedForDentalInterventions")
                        .HasMaxLength(1)
                        .HasColumnType("character varying(1)");
            ...
            modelBuilder.Entity("App.Domain.Models.Users.Supervise", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("App.Domain.Models.Users.Supervise", b =>
                {
                    b.HasOne("App.Domain.Models.Users.ApplicationUser", "Doctor")
                        .WithMany("SuperviseDoctorNavigation")
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("App.Domain.Models.Users.ApplicationUser", "Student")
                        .WithMany("SuperviseStudentNavigation")
                        .HasForeignKey("StudentId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("App.Domain.Models.Users.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("SuperviseDoctorNavigation");

                    b.Navigation("SuperviseStudentNavigation");
